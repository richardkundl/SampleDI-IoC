...
namespace SampleDI.Cryptography
{
    public class AsymmetricKeyPairGenerationResult : ResponseBase
    {
        ...
        {
            if (fullKeyPairXml == null)
            {
                throw new ArgumentNullException("Full key pair XML");
            }

            if (publicKeyOnlyXml == null)
            {
                throw new ArgumentNullException("Public key only XML");
            }
        ...
        {
            get { return _fullKeyPairXml; }
        }

        public XDocument PublicKeyOnlyXml
        {
            get { return _publicKeyOnlyXml; }
        }
    }
}
